function GameLoop(_options) {
	...
	//Gebaeudevariablen
	var _broodLevel = 0;
	//Anzahl aller Gebaeudelevel vom gleichen Typ
	...
	this.requestUpdate = function(buildingId) {
		if (buildedBuildings[buildingId].upgradeCost.stone <= _stone && buildedBuildings[buildingId].upgradeCost.leafs <= _leafs && buildedBuildings[buildingId].upgradeCost.food <= _food) {
